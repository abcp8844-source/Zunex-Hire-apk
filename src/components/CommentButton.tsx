...
import { fetchComments, addComment, supabase } from '../services/postService';
...
export const CommentButton: React.FC<CommentButtonProps> = ({ postId, commentCount = 0 }) => {
  ...
  const handleStartReply = (authorName: string, commentId: string) => {
                    ...
                    <View style={styles.commentItem}>
                      ...
                      <View style={styles.commentContentWrapper}>
                        ...
                        <View style={styles.commentActionsRow}>
                          ...
                          <TouchableOpacity onPress={() => handleStartReply(authorName, item.id)}>
